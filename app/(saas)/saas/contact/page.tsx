...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://digitribe.co/saas/contact' },
  openGraph: {
    title: 'Contact Digitribe — for SaaS founders',
    images: [{ url: '/og/saas-contact.png', width: 1200, height: 630 }],
  },
}
...
const paths = [
  { icon: <CalendarIcon />, title: 'Free 30-min audit', body: "We'll review your site, your ads, and your funnel — and tell you exactly what we'd change. You walk away with a punch list whether you hire us or not.", cta: 'Book the audit', href: '/saas/audit', external: false },
            ...
            {paths.map((path) => (
              ...
              >
                ...
                <h2
                  ...
                  style={{ fontFamily: 'var(--font-display)', color: 'var(--color-text-on-inverse)' }}
                >
                  {path.title}
                </h2>
                <p className="text-sm leading-relaxed flex-1 mb-8" style={{ color: 'var(--color-text-on-inverse)', opacity: 0.65 }}>
                  {path.body}
                </p>
                {path.external ? (
                  <a
