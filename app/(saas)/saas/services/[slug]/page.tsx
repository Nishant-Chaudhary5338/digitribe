...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://digitribe.co/saas/services/${service.slug}` },
    openGraph: {
...
export default async function SaaSServiceDetailPage({ params }: Props) {
  const { slug } = await params
  const service = getServiceBySlug(slug)
  if (!service) notFound()
  ...
  const breadcrumbItems = [
    ...
    { label: service.name, href: `/saas/services/${service.slug}` },
  ]
          ...
          <div className="grid gap-16 lg:grid-cols-[60fr_40fr] lg:items-start">
            ...
            <div className="lg:sticky lg:top-8">
              ...
              >
                ...
                <Link
                  href={`/saas/audit?service=${service.slug}`}
